...
function UnitRow({unitName, modelCount, pointCost, unitSize, unitId, readyToStandby}){
    return (
        <div className="font-bold underline border-black col-span-8 row-span-5 border-2 p-4">
          ...
          <button className="rounded-md p-1 m-1 bg-slate-50" onClick={()=>{}}>Remove</button>
          <button className="rounded-md p-1 m-1 bg-slate-50" onClick={()=>{readyToStandby(unitId)}}>Move to Standby</button>
